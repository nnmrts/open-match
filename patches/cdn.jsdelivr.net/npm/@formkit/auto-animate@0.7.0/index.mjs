...
function deletePosition(el) {
	...
	const [
		width, , height
	] = getTransitionSizes(el, oldCoords, getCoords(el));
...
function autoAnimate(el, config = {}) {
	...
	if (mutations && resize) {
		console.log("autoAnimate - enabled");
		console.log(mutations);
		console.log(resize);
		...
		if (!isDisabledDueToReduceMotion) {
			console.log("autoAnimate - enabled - not disabled due to reduce motion");
			enabled.add(el);
			if (getComputedStyle(el).position === "static") {
				console.log("autoAnimate - enabled - not disabled due to reduce motion - position static");
